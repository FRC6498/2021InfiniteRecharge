 ...
 */
public class Custom extends AutoModeBase {
    ...
    protected void routine() throws AutoModeEndedException {
        ...
        first_path.add(new Waypoint(new Translation2d(0, 0), 30.0));
        first_path.add(new Waypoint(new Translation2d(48, 0), 30.0));
        first_path.add(new Waypoint(new Translation2d(48, 48), 30.0));
        //first_path.add(new Waypoint(new Translation2d(6000,0), 30.0));
        //first_path.add(new Waypoint(new Translation2d(60,60), 50.0));

        List<Waypoint> second_path = new ArrayList<>();
        second_path.add(new Waypoint(new Translation2d(48, 48), 15.0));
        second_path.add(new Waypoint(new Translation2d(48+48,0), 15.0));

        List<Waypoint> third_path = new ArrayList<>();
        second_path.add(new Waypoint(new Translation2d(48+48, 0), 15.0));
        second_path.add(new Waypoint(new Translation2d(0,0), 15.0));
     ...
     /*   List<Waypoint> second_path = new ArrayList<>();
        ...
        //runAction(new FollowPathAction(new Path(third_path), false));
